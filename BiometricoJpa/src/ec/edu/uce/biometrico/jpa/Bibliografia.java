...
public class Bibliografia implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9198702725465810204L;
	private Integer bblId;
	private UnidadCurricular bblUnidadCurricular;
	...
	public Bibliografia(Integer bblId) {
		this.bblId = bblId;
	}

	public Bibliografia(Integer bblId, UnidadCurricular unidadCurricular) {
		this.bblId = bblId;
		this.bblUnidadCurricular = unidadCurricular;
	}
	...
	public UnidadCurricular getBblUnidadCurricular() {
		return this.bblUnidadCurricular;
	}

	public void setBblUnidadCurricular(UnidadCurricular unidadCurricular) {
		this.bblUnidadCurricular = unidadCurricular;
	}
