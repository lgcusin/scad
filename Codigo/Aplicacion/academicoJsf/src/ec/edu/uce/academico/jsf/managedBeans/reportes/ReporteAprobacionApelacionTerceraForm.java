 ...
 ************************************************************************* 
 ...
 ARCHIVO:     ReporteAprobacionApelacionTerceraForm.java	  
 DESCRIPCION: Bean de sesion que maneja el reporte  de aprobación/negación de la apelación de tercera matricula realizada por el Secretario Abogado de la Facultad..
 *************************************************************************
                           	MODIFICACIONES
                            
 FECHA         		     AUTOR          					COMENTARIOS
 24-03-2018			 Marcelo Quishpe                         Emisión Inicial
 ***************************************************************************/
...
/**
 * Clase (session bean) ReporteAprobacionApelacionTerceraForm. 
 * Bean de sesion que maneja el reporte de aprobacion/negación de la apelación de tercera matricula realizada por el Secretario Abogado de la Facultad.
 * @author lmquishpei.
 * @version 1.0
 */

@ManagedBean(name = "reporteAprobacionApelacionTerceraForm")
@SessionScoped
public class ReporteAprobacionApelacionTerceraForm implements Serializable {
	...
	public static void generarReporteAprobacionApelacionTercera(List<SolicitudTerceraMatriculaDto> listaMaterias, Dependencia dpn, Carrera crr, Persona prs, PeriodoAcademico prac, Usuario usr, String observaciones){
