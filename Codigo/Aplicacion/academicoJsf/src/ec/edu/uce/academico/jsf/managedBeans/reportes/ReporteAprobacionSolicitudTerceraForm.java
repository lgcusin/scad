 ...
 ************************************************************************* 
 ...
 ARCHIVO:     ReporteAprobacionSolicitudTerceraForm.java	  
 DESCRIPCION: Bean de sesion que maneja el reporte de aprobacion de solicitud de tercera matricula realizada por el Director de carrera.
 *************************************************************************
                           	MODIFICACIONES
                            
 FECHA         		     AUTOR          					COMENTARIOS
 07-03-2018			 Marcelo Quishpe                         Emisión Inicial
 ***************************************************************************/
...
/**
 * Clase (session bean) ReporteAprobacionSolicitudTerceraForm. 
 * Bean de sesion que maneja el reporte de aprobacion de solicitud de tercera matricula realizada por el Director de carrera.
 * @author lmquishpei.
 * @version 1.0
 */

@ManagedBean(name = "reporteAprobacionSolicitudTerceraForm")
@SessionScoped
public class ReporteAprobacionSolicitudTerceraForm implements Serializable {
	...
	public static void generarReporteAprobacionTercera(List<SolicitudTerceraMatriculaDto> listaMaterias, Dependencia dpn, Carrera crr, Persona prs, PeriodoAcademico prac, Usuario usr, String observaciones){
		...
		// ***************************************************************************************************************//
		// ********* GENERACION DEL REPORTE DE APROBACION DE SOLICITUD TERCERA MATRICULA HECHA POR EL DIRCARRERA *********//
		// ***************************************************************************************************************//
		// **************************************************************************************************************//
		...
		String fecha = formato.format(new Date()); //Fecha de impresion del reporte.
		...
		String nombres=prs.getPrsNombres()+" "+prs.getPrsPrimerApellido().toUpperCase()+" "
				+(prs.getPrsSegundoApellido() == null?" ":prs.getPrsSegundoApellido());
		...
		for (SolicitudTerceraMatriculaDto item : listaMaterias) {
			...
			if(usr!=null){
			  directorCarrera = usr.getUsrPersona().getPrsNombres()+" "+usr.getUsrPersona().getPrsPrimerApellido().toUpperCase()+" "
...
//	public static void generarReporteReimpresion(List<SolicitudTerceraMatriculaDto> listaSolicitudes, PersonaDto decanoFcl, Usuario usr){
//		
//		try{	
//			List<Map<String, Object>> frmRrmCampos = null;
//			Map<String, Object> frmRrmParametros = null;
...
//			String dirCarrera = decanoFcl.getPrsNombres()+" "+decanoFcl.getPrsPrimerApellido().toUpperCase()+" "
//					+(decanoFcl.getPrsSegundoApellido() == null?" ":decanoFcl.getPrsSegundoApellido());
//			
//			StringBuilder sbTextoInicial = new StringBuilder();
