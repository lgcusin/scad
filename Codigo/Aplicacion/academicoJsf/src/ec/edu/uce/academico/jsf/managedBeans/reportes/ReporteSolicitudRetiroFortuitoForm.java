 ...
 ************************************************************************* 
 ...
 ARCHIVO:     ReporteSolicitudRetiroFortuitoForm.java	  
 DESCRIPCION: Bean de sesion que maneja el reporte de la solicitud de retiro por situaciones fortuitas del estudiante. 
 *************************************************************************
                           	MODIFICACIONES
                            
 FECHA         		     AUTOR          					COMENTARIOS
 07-ene-2019			 Marcelo Quishpe                         Emisión Inicial
 ***************************************************************************/
...
/**
 * Clase (session bean) ReporteSolicitudRetiroFortuitoForm. 
 * Bean de sesion que maneja aneja el reporte de la solicitud de retiro por situaciones fortuitas del estudiante..
 * @author lmquishpei.
 * @version 1.0
 */

@ManagedBean(name = "reporteSolicitudRetiroFortuitoForm")
@SessionScoped
public class ReporteSolicitudRetiroFortuitoForm implements Serializable {
	...
	public static void generarReporteSolicitudRetiroFortuito(List<EstudianteJdbcDto> listaMaterias, Dependencia dpn, Carrera crr, Persona prs, PeriodoAcademico prac, Usuario usr, PersonaDto directorCarrera){
