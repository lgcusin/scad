 ...
 ************************************************************************* 
 ...
 ARCHIVO:     ReporteApelacionTerceraForm.java	  
 DESCRIPCION: Bean de sesion que maneja el reporte de la apelación de tercera matrícula del estudiante. 
 *************************************************************************
                           	MODIFICACIONES
                            
 FECHA         		     AUTOR          					COMENTARIOS
 20-03-2018			 Marcelo Quishpe                         Emisión Inicial
 ***************************************************************************/
 ...
 * Bean de sesion que maneja aneja el reporte de la apelacion de tercera matrícula del estudiante..
 * @author lmquishpei.
 * @version 1.0
 */

@ManagedBean(name = "reporteApelacionTerceraForm")
@SessionScoped
public class ReporteApelacionTerceraForm implements Serializable {
	...
	public static void generarReporteApelacionTercera(List<MateriaDto> listaMaterias, Dependencia dpn, Carrera crr, Persona prs, PeriodoAcademico prac, Usuario usr, PersonaDto decanoFcl){
	...
	try{	
		...
		// ****************************************************************//
		// ********* GENERACION DEL REPORTE  DE APELACION DE TERCERA MATRICULA  DEL ESTUDIANTE*********//
		// ****************************************************************//
		// ****************************************************************//
...
//			}
		...
		if(decanoFcl!=null){
			decanofcl = decanoFcl.getPrsNombres()+" "+decanoFcl.getPrsPrimerApellido().toUpperCase()+" "
...
public static void generarReporteApelacionTerceraLista(List<SolicitudTerceraMatriculaDto> lista, Dependencia dpn, Carrera crr, Persona prs, PeriodoAcademico prac, Usuario usr, PersonaDto decanoFcl){
...
//				}
			...
			sbTextoInicial.append("Presente.- ");sbTextoInicial.append("\n\n");
			sbTextoInicial.append("Señor(a) Decano(a)");sbTextoInicial.append("\n");
			...
			sbTexto.append(" ,solicito a usted muy comedidamente me conceda la autorización respectiva para realizar la apelación de Tercera Matrícula en la(s) siguiente(s) asignatura(s): ");
			...
			StringBuilder sbCausal = new StringBuilder();
			StringBuilder sbEvidencia = new StringBuilder();
			for (SolicitudTerceraMatriculaDto item : lista) {
				if(item.getMtrDescripcion().length() <= 44){
