 ...
 * @version 1.0
 */
public class AulaDtoNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public AulaDtoNoEncontradoException() {
		super();
	}
	 ...
	 */
	public AulaDtoNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public AulaDtoNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public AulaDtoNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
