 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:    ReferenciaException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Referencia.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)ReferenciaException.
 * Clase de excepcion general para la entidad Referencia.
 * @author dcollaguazo
 * @version 1.0
 */
public class ReferenciaException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public ReferenciaException(Throwable cause) {
		super(cause);
	}
}
