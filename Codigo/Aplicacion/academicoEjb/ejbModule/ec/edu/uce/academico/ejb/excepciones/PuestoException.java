 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:    PuestoException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Puesto.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)PuestoException.
 * Clase de excepcion general para la entidad Puesto.
...
public class PuestoException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public PuestoException(Throwable cause) {
		super(cause);
	}
}
