 ...
 * @version 1.0
 */
public interface NotasPregradoDtoServicioJdbc {
	...
	public List<EstudianteJdbcDto> buscarEstudianteRectificacionRecuperacionPosgrado(int idCarrera, int idNivel,
			int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

//	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteModular(int idCarrera,
//			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
//			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteModular(int idCarrera,
			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr, int idModulo)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;


	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteCompartidaModulos(
			int idRcesMlcrpr) throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXMallaCurricularParaleloId(Integer mlcrprId)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;


	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteModularRecuperacion(
			int idCarrera, int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr, int idModulo)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;
	 ...
	 * @throws EstudianteDtoJdbcNoEncontradoException - EstudianteDtoJdbcNoEncontradoException excepción cuando no encuentra estudiantes con los parametros ingresados
	 */
	public List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteCulturaFisica(int idCarrera,
			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	/**@author jdalbuja -- soy el autor porque aumenté una línea de código y ahora soy autor full
	 * Método que busca una lista de estudiantes por periodo carrera nivel paralelo materia docente
	 * @param idPeriodo - idPeriodo id del periodo academico a buscar
	 * @param idCarrera - idCarrera id de la carrera a buscar
	 * @param idNivel - idNivel id del nivel a buscar
	 ...
	 * @throws EstudianteDtoJdbcNoEncontradoException - EstudianteDtoJdbcNoEncontradoException excepción cuando no encuentra estudiantes con los parametros ingresados
	 */
	public List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteCompartidaCulturaFisica(
			int idCarrera, int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteCierre(int idCarrera,
			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteCompartidaCierre(
			int idCarrera, int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<MateriaDto> buscarEstudianteNotasMateriaModularXMateriaXPeriodoXIdentificacion(int idMateria,
			int idPeriodo, String identificacion)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<MateriaDto> buscarEstudianteNotasMateriasModulosXMateriaXPeriodoXIdentificacion(int idRecordEstudiante, int idPeriodo,
			String identificacion) throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteModularAnterior(
			int idCarrera, int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr, int idModulo)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXMallaCurricularParaleloIdAnterior(Integer mlcrprId)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteAnterior(int idCarrera,
			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXParalelo(int idParalelo, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	void correccionRecordEstudianteModulares();

	List<EstudianteJdbcDto> buscarEstudianteXParaleloXpracId(int idParalelo, int idRcesMlcrpr, Integer pracId)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXmlcrprIdPosgrado(int idRcesMlcrprId)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXParaleloPeriodoInactivo(int idParalelo, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXParaleloInactivoMedicina(int idParalelo, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudiantesEstadisticasPasoNotas(int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;

	List<EstudianteJdbcDto> buscarEstudianteXperiodoXcarreraXnivelXparaleloXmateriaXdocenteEnLinea(int idCarrera,
			int idNivel, int idParalelo, int idMateria, int idDocente, int idRcesMlcrpr)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;


	List<EstudianteJdbcDto> buscarEstudiantesModularXPeriodoAnterior(int idCarrera, int idNivel, int idParalelo,
			int idMateria, int idDocente, int idRcesMlcrpr, int idModulo, int pracId)
			throws EstudianteDtoJdbcException, EstudianteDtoJdbcNoEncontradoException;
