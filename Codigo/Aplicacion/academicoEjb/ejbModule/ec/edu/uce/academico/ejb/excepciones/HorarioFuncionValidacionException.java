 ...
 * @version 1.0
 */
public class HorarioFuncionValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public HorarioFuncionValidacionException() {
		super();
	}
	 ...
	 */
	public HorarioFuncionValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public HorarioFuncionValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public HorarioFuncionValidacionException(Throwable cause) {
		super(cause);
	}
}
