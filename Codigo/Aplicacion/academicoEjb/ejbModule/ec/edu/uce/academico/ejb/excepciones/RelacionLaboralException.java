 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:    RelacionLaboralException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad RelacionLaboral.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)RelacionLaboralException.
 * Clase de excepcion general para la entidad RelacionLaboral.
 * @author ajvillafuerte
 * @version 1.0
 */
public class RelacionLaboralException extends Exception{
