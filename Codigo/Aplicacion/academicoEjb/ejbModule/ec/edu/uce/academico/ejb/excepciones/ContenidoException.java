 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:    ContenidoException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Contenido.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)ContenidoException.
 * Clase de excepcion general para la entidad Contenido.
...
public class ContenidoException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public ContenidoException(Throwable cause) {
		super(cause);
	}
}
