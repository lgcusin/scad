 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:     MateriaException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Materia.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)MateriaException.
 * Clase de excepcion general para la entidad Materia.
 * @author dalbuja
 * @version 1.0
 */
public class MateriaException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public MateriaException(Throwable cause) {
		super(cause);
	}
}
