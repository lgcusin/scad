 ...
 * @version 1.0
 */
public class AsignacionEvaluadorValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public AsignacionEvaluadorValidacionException() {
		super();
	}
	 ...
	 */
	public AsignacionEvaluadorValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public AsignacionEvaluadorValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public AsignacionEvaluadorValidacionException(Throwable cause) {
		super(cause);
	}
}
