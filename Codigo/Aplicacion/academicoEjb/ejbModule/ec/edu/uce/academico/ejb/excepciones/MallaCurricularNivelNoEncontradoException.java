 ...
 * @version 1.0
 */
public class MallaCurricularNivelNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public MallaCurricularNivelNoEncontradoException() {
		super();
	}
	 ...
	 */
	public MallaCurricularNivelNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public MallaCurricularNivelNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public MallaCurricularNivelNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
