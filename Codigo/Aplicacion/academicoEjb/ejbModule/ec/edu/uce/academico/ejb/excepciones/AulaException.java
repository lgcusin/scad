 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:     AulaException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Aula.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)AulaException.
 * Clase de excepcion general para la entidad Aula.
 * @author lmquishpei
 * @version 1.0
 */
public class AulaException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public AulaException(Throwable cause) {
		super(cause);
	}
}
