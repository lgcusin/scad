 ...
 ************************************************************************* 
 ...
 ARCHIVO:     PrerequisitosDto.java	  
 DESCRIPCION: DTO encargado de manejar los datos de la entidad PrerequisitosDto. 
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (DTO) PrerequisitosDto.
 * DTO encargado de manejar los datos de la entidad PrerequisitosDto. 
 * @author lmquishpei.
 * @version 1.0
 */
public class PrerequisitoDto implements Serializable{
	...
	public String toString() {
		...
		sb.append(tabulador + "prrEstado : " + (prrEstado==null? "NULL":prrEstado));
