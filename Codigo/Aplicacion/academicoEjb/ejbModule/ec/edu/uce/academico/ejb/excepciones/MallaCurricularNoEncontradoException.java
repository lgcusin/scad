 ...
 * @version 1.0
 */
public class MallaCurricularNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public MallaCurricularNoEncontradoException() {
		super();
	}
	 ...
	 */
	public MallaCurricularNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public MallaCurricularNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public MallaCurricularNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
