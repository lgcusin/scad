 ...
 * @version 1.0
 */
public class ComprobantePagoValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public ComprobantePagoValidacionException() {
		super();
	}
	 ...
	 */
	public ComprobantePagoValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public ComprobantePagoValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public ComprobantePagoValidacionException(Throwable cause) {
		super(cause);
	}
}
